...
- **Skill:** `.agents/skills/add-k8s-option/` (full procedural walkthrough)
...
- **Skill:** `.agents/skills/add-backend/` (full procedural walkthrough)
...
- **Skill:** `.agents/skills/update-api-dep/` (full procedural walkthrough)
...
- **Skill:** `.agents/skills/add-kep-proposal/` (full procedural walkthrough)
...
- **Skill:** `.agents/skills/add-sdk-client/` (full procedural walkthrough)
